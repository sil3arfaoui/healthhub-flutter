...
class AddPostWidget extends StatefulWidget {
  ...
  final PostRecord? ref;

  static String routeName = 'addPost';
  static String routePath = '/addPost';
...
class _AddPostWidgetState extends State<AddPostWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.ref?.fullName);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: widget.ref?.title);
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??=
        TextEditingController(text: widget.ref?.content);
            ...
            children: [
              StreamBuilder<List<PostRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<PostRecord> formPostRecordList = snapshot.data!;
