...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF141516);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF141516);
  late Color secondaryText = const Color(0xFFB8B8B8);
  late Color primaryBackground = const Color(0xFFFAFAFA);
  late Color secondaryBackground = const Color(0xFF858586);
  late Color accent1 = const Color(0xFF858586);
  late Color accent2 = const Color(0xFFCFCFCF);
  late Color accent3 = const Color(0xCC141516);
  late Color accent4 = const Color(0xFF6A6A6A);
  late Color success = const Color(0xFF5FAA7D);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFCC5C5C);
  late Color info = const Color(0xFFFFFFFF);

  late Color accent5 = const Color(0xFFE2E2E2);
}
