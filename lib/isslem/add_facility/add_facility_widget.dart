...
import 'add_facility_model.dart';
export 'add_facility_model.dart';

class AddFacilityWidget extends StatefulWidget {
  const AddFacilityWidget({
    super.key,
    required this.selectedTypeFromList,
  });

  final String? selectedTypeFromList;

  static String routeName = 'AddFacility';
  static String routePath = '/addFacility';

  @override
  State<AddFacilityWidget> createState() => _AddFacilityWidgetState();
}

class _AddFacilityWidgetState extends State<AddFacilityWidget> {
  late AddFacilityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddFacilityModel());

    _model.nameTextController ??= TextEditingController();
    _model.nameFocusNode ??= FocusNode();

    _model.typeTextController ??=
        TextEditingController(text: widget.selectedTypeFromList);
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await FacilityDetailsRecord.collection
                              .doc()
                              .set(createFacilityDetailsRecordData(
