...
import 'update_facility_model.dart';
export 'update_facility_model.dart';

class UpdateFacilityWidget extends StatefulWidget {
  const UpdateFacilityWidget({
    super.key,
    required this.type,
  });

  final FacilityDetailsRecord? type;

  static String routeName = 'UpdateFacility';
  static String routePath = '/updateFacility';

  @override
  State<UpdateFacilityWidget> createState() => _UpdateFacilityWidgetState();
}

class _UpdateFacilityWidgetState extends State<UpdateFacilityWidget> {
  late UpdateFacilityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateFacilityModel());
    ...
    _model.typeTextController ??=
        TextEditingController(text: widget.type?.type);
    _model.typeFocusNode ??= FocusNode();

    _model.addressTextController ??=
        TextEditingController(text: widget.type?.address);
    _model.addressFocusNode ??= FocusNode();

    _model.emailTextController ??=
        TextEditingController(text: widget.type?.email);
    _model.emailFocusNode ??= FocusNode();

    _model.phoneTextController ??=
        TextEditingController(text: widget.type?.phone);
                ...
                Padding(
                  ...
                  child: StreamBuilder<List<CountriesRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<CountriesRecord> dropDownCountriesRecordList =
                          snapshot.data!;

                      return FlutterFlowDropDown<String>(
                        controller: _model.dropDownValueController ??=
                            FormFieldController<String>(
                          _model.dropDownValue ??= widget.type?.country,
                        ),
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await widget.type!.reference
                              .update(createFacilityDetailsRecordData(
