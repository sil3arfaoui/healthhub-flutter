...
import 'rymaadd_model.dart';
export 'rymaadd_model.dart';

class RymaaddWidget extends StatefulWidget {
  const RymaaddWidget({
    super.key,
    this.description,
    this.title,
  ...
  static String routeName = 'rymaadd';
  static String routePath = '/rymaadd';

  @override
  State<RymaaddWidget> createState() => _RymaaddWidgetState();
}

class _RymaaddWidgetState extends State<RymaaddWidget> {
  late RymaaddModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RymaaddModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      unawaited(
        () async {
          await EventsRecord.collection.doc().set(createEventsRecordData(
                title: '',
                description: '',
                category: '',
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            FFButtonWidget(
              onPressed: () async {
                context.pushNamed(RymareadWidget.routeName);
              },
              text: 'List',
                                  ...
                                  children: [
                                    StreamBuilder<List<EventsRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<EventsRecord>
                                            textField1EventsRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final textField1EventsRecord =
                                            textField1EventsRecordList
                                                    .isNotEmpty
                                                ? textField1EventsRecordList
                                                    .first
                            ...
                            Padding(
                              ...
                              child: StreamBuilder<List<EventsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<EventsRecord> calendarEventsRecordList =
                                      snapshot.data!;
                                  // Return an empty Container when the item does not exist.
                                  if (snapshot.data!.isEmpty) {
                                    return Container();
                                  ...
                                  final calendarEventsRecord =
                                      calendarEventsRecordList.isNotEmpty
                                          ? calendarEventsRecordList.first
                                          : null;
