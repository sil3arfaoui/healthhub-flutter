...
import 'yassinecard_model.dart';
export 'yassinecard_model.dart';

class YassinecardWidget extends StatefulWidget {
  const YassinecardWidget({
    super.key,
    required this.produitcompref,
  });

  final DocumentReference? produitcompref;

  static String routeName = 'yassinecard';
  static String routePath = '/yassinecard';

  @override
  State<YassinecardWidget> createState() => _YassinecardWidgetState();
}

class _YassinecardWidgetState extends State<YassinecardWidget> {
  late YassinecardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => YassinecardModel());
                      ...
                      children: [
                        Padding(
                          ...
                          child: FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              context
                                  .pushNamed(YassinehomepageWidget.routeName);
                            },
                          ),
                        ),
                        Padding(
